% This code used to remove certain data from the time series data as we
% thought it was not data within the year we were looking for. However it
% was realised that we required all data in a table so this is now kept
% here just to remind me of how I restructured the table in case I need to
% do this again
