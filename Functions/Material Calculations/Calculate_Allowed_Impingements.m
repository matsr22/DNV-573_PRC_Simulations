function allowed_imp = Calculate_Allowed_Impingements(input_values,v_grid,d_grid)
    ...
    % Input values is a vector of the material properties relevant to the
    % equaton. 
    ...
    % Vectorised equation allowing for d_grid and v_grid to produce an
    % allowed impingements matrix
